...
Locate transcripts and their record format through the active harness profile. Use only records belonging to the current workspace; if the harness exposes no transcript access, use the visible conversation and say what history is unavailable.
